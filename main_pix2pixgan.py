...
parser.add_argument('--originalSize', type=int, 
  default=286, help='the height / width of the original input image(286, or 572)')
...
parser.add_argument('--lambdaIMG', type=float, default=100, help='lambda_image, default=100')
parser.add_argument('--wd', type=float, default=0.0000, help='weight decay, default=0.0004')
...
parser.add_argument('--display', type=int, default=1, help='Where to store samples and models')
parser.add_argument('--evalIter', type=int, default=500, help='evauating(generating) image')
...
vutils.save_image(val_target, '%s/real_target.png' % opt.exp)
vutils.save_image(val_input, '%s/real_input.png' % opt.exp)
